...
| ------------- | ------------- |
| 1. Посмотрим на название страницы|  В названии
страницы есть “КиноПоиск” |
...
| Steps  | Expected results  |
| ------------- | ------------- |
| 1. Ввести в поле "Фильмы, сериалы, персоны" название несуществующего фильма "Абвагад ывфр" | Успешно введено |
